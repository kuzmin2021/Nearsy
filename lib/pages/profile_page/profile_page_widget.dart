...
class _ProfilePageWidgetState extends State<ProfilePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      String canonicalProfileAttribute(dynamic value) {
        final text = cleanValue(value).toLowerCase();
        if (text.isEmpty) {
          return '';
        }
        final normalized = text
      ...
      String normalizeProfileAttribute(String attribute, dynamic rawValue) {
      ...
      String localizeProfileAttribute(String attribute, dynamic rawValue) {
        final value = normalizeProfileAttribute(attribute, rawValue);
        if (value.isEmpty) {
          return '';
        }
        final languageCode =
