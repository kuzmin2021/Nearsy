...
CREATE OR REPLACE FUNCTION "public"."create_user_settings_for_new_user"() RETURNS "trigger"
...
ALTER FUNCTION "public"."create_user_settings_for_new_user"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_account_data_v2"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."delete_account_data_v2"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_discovery_feed_v2"("p_limit" integer DEFAULT 20, "p_offset" integer DEFAULT 0) RETURNS TABLE("profile_id" bigint, "user_id" "uuid", "display_name" "text", "age" integer, "gender" "text", "catchphrase" "text", "description" "text", "avatar_url" "text", "distance_km" double precision, "photos" "jsonb", "location_label" "text", "work" "text", "education" "text", "kids" "text", "relationship_type" "text", "religion" "text", "body_type" "text", "exercise" "text", "drinking" "text", "smoking" "text", "height" "text", "languages" "text")
...
ALTER FUNCTION "public"."get_discovery_feed_v2"("p_limit" integer, "p_offset" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_nearby_profiles_v2"("p_radius_km" integer DEFAULT 25, "p_limit" integer DEFAULT 50) RETURNS TABLE("profile_id" bigint, "user_id" "uuid", "display_name" "text", "age" integer, "gender" "text", "avatar_url" "text", "location_label" "text", "distance_km" double precision)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $_$
  with me as (
...
ALTER FUNCTION "public"."get_nearby_profiles_v2"("p_radius_km" integer, "p_limit" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_user_settings_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."set_user_settings_updated_at"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."conversations" (
    ...
    "user1" "uuid" NOT NULL,
    "user2" "uuid" NOT NULL,
    "match_created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "last_message_at" timestamp with time zone,
    "last_message_id" bigint,
    "deleted_for" "text"[] DEFAULT '{}'::"text"[] NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "location_mode" "text" DEFAULT 'visible'::"text" NOT NULL,
...
ALTER TABLE "public"."swipe_events" OWNER TO "postgres";


ALTER TABLE "public"."swipe_events" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."swipe_events_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."user_feed_queue" (
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."user_feed_queue" OWNER TO "postgres";
...
ALTER TABLE "public"."user_photos" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."user_photos_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."user_preferences" (
    ...
    "preferred_genders" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "location" "public"."geometry"(Point,4326),
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "languages" "text",
    "kids" "text",
...
CREATE TABLE IF NOT EXISTS "public"."user_seen_profiles" (
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."user_seen_profiles" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."user_settings" (
    ...
    "push_liked_you" boolean DEFAULT true NOT NULL,
    "email_matches" boolean DEFAULT true NOT NULL,
    "email_messages" boolean DEFAULT true NOT NULL,
    "email_liked_you" boolean DEFAULT true NOT NULL,
    "chat_mode" "text" DEFAULT 'friends'::"text" NOT NULL
);
...
ALTER TABLE ONLY "public"."blocks"
    ADD CONSTRAINT "blocks_unique" UNIQUE ("blocker", "blocked");
...
ALTER TABLE ONLY "public"."likes"
    ADD CONSTRAINT "likes_pkey" PRIMARY KEY ("user_id", "liked_user_id");



ALTER TABLE ONLY "public"."matches"
    ADD CONSTRAINT "matches_pkey" PRIMARY KEY ("user1", "user2");
...
ALTER TABLE ONLY "public"."swipe_events"
    ADD CONSTRAINT "swipe_events_user_target_unique" UNIQUE ("user_id", "target_user_id");



ALTER TABLE ONLY "public"."user_feed_queue"
    ADD CONSTRAINT "user_feed_queue_pkey" PRIMARY KEY ("user_id", "candidate_user_id");
...
ALTER TABLE ONLY "public"."user_seen_profiles"
    ADD CONSTRAINT "user_seen_profiles_pkey" PRIMARY KEY ("user_id", "seen_user_id");
...
CREATE OR REPLACE TRIGGER "set_user_settings_updated_at" BEFORE UPDATE ON "public"."user_settings" FOR EACH ROW EXECUTE FUNCTION "public"."set_user_settings_updated_at"();



ALTER TABLE ONLY "public"."blocks"
    ADD CONSTRAINT "blocks_blocked_fkey" FOREIGN KEY ("blocked") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."blocks"
    ADD CONSTRAINT "blocks_blocker_fkey" FOREIGN KEY ("blocker") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."conversations"
    ADD CONSTRAINT "conversations_user1_fkey" FOREIGN KEY ("user1") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."conversations"
    ADD CONSTRAINT "conversations_user2_fkey" FOREIGN KEY ("user2") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."likes"
    ADD CONSTRAINT "likes_liked_user_id_fkey" FOREIGN KEY ("liked_user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."matches"
    ADD CONSTRAINT "matches_user1_fkey" FOREIGN KEY ("user1") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."matches"
    ADD CONSTRAINT "matches_user2_fkey" FOREIGN KEY ("user2") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."reports"
    ADD CONSTRAINT "reports_reported_fkey" FOREIGN KEY ("reported") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."reports"
    ADD CONSTRAINT "reports_reporter_fkey" FOREIGN KEY ("reporter") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_feed_queue"
    ADD CONSTRAINT "user_feed_queue_candidate_user_id_fkey" FOREIGN KEY ("candidate_user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_feed_queue"
    ADD CONSTRAINT "user_feed_queue_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."user_seen_profiles"
    ADD CONSTRAINT "user_seen_profiles_seen_user_id_fkey" FOREIGN KEY ("seen_user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_seen_profiles"
    ADD CONSTRAINT "user_seen_profiles_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "conversation_reads_insert_own" ON "public"."conversation_reads" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "conversation_reads_select_own" ON "public"."conversation_reads" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "conversation_reads_update_own" ON "public"."conversation_reads" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "conversations_select_participant" ON "public"."conversations" FOR SELECT USING ((("auth"."uid"() = "user1") OR ("auth"."uid"() = "user2")));



CREATE POLICY "conversations_update_participant" ON "public"."conversations" FOR UPDATE USING ((("auth"."uid"() = "user1") OR ("auth"."uid"() = "user2")));
...
CREATE POLICY "likes_select_related" ON "public"."likes" FOR SELECT USING ((("auth"."uid"() = "user_id") OR ("auth"."uid"() = "liked_user_id")));
...
CREATE POLICY "matches_select_participant" ON "public"."matches" FOR SELECT USING ((("auth"."uid"() = "user1") OR ("auth"."uid"() = "user2")));
...
CREATE POLICY "messages_insert_participant" ON "public"."messages" FOR INSERT WITH CHECK ((("auth"."uid"() = "sender_id") AND (("auth"."uid"() IN ( SELECT "conversations"."user1"
   FROM "public"."conversations"
  WHERE ("conversations"."id" = "messages"."conversation_id"))) OR ("auth"."uid"() IN ( SELECT "conversations"."user2"
   FROM "public"."conversations"
  WHERE ("conversations"."id" = "messages"."conversation_id"))))));



CREATE POLICY "messages_select_participant" ON "public"."messages" FOR SELECT USING ((("auth"."uid"() IN ( SELECT "conversations"."user1"
   FROM "public"."conversations"
  WHERE ("conversations"."id" = "messages"."conversation_id"))) OR ("auth"."uid"() IN ( SELECT "conversations"."user2"
   FROM "public"."conversations"
  WHERE ("conversations"."id" = "messages"."conversation_id")))));
...
CREATE POLICY "profiles_select_visible" ON "public"."profiles" FOR SELECT USING (true);
...
CREATE POLICY "reports_insert_own" ON "public"."reports" FOR INSERT WITH CHECK (("auth"."uid"() = "reporter"));



CREATE POLICY "reports_select_own" ON "public"."reports" FOR SELECT USING ((("auth"."uid"() = "reporter") OR ("auth"."uid"() = "reported")));
...
CREATE POLICY "swipe_events_self" ON "public"."swipe_events" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



ALTER TABLE "public"."user_feed_queue" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "user_feed_queue_select_own" ON "public"."user_feed_queue" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "user_photos_delete_own" ON "public"."user_photos" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "user_photos_insert_own" ON "public"."user_photos" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "user_photos_select_visible" ON "public"."user_photos" FOR SELECT USING (true);



CREATE POLICY "user_photos_update_own" ON "public"."user_photos" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "user_seen_insert_own" ON "public"."user_seen_profiles" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



ALTER TABLE "public"."user_seen_profiles" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "user_seen_select_own" ON "public"."user_seen_profiles" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
GRANT ALL ON FUNCTION "public"."create_user_settings_for_new_user"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_user_settings_for_new_user"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_user_settings_for_new_user"() TO "service_role";



GRANT ALL ON FUNCTION "public"."delete_account_data_v2"() TO "anon";
GRANT ALL ON FUNCTION "public"."delete_account_data_v2"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_account_data_v2"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_discovery_feed_v2"("p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_discovery_feed_v2"("p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_discovery_feed_v2"("p_limit" integer, "p_offset" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_nearby_profiles_v2"("p_radius_km" integer, "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_profiles_v2"("p_radius_km" integer, "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_profiles_v2"("p_radius_km" integer, "p_limit" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."set_user_settings_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_user_settings_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_user_settings_updated_at"() TO "service_role";
...
GRANT ALL ON TABLE "public"."user_feed_queue" TO "anon";
GRANT ALL ON TABLE "public"."user_feed_queue" TO "authenticated";
GRANT ALL ON TABLE "public"."user_feed_queue" TO "service_role";
...
GRANT ALL ON TABLE "public"."user_seen_profiles" TO "anon";
GRANT ALL ON TABLE "public"."user_seen_profiles" TO "authenticated";
GRANT ALL ON TABLE "public"."user_seen_profiles" TO "service_role";
...
INSERT INTO "public"."profiles" ("id","user_id","display_name","email","catchphrase","avatar_url","updated_at","gender","birthday","languages","height","work","education","kids","relationship_type","body_type","exercise","drinking","smoking","description","location_label","height_cm","religion","is_metric","deleted_at","is_hidden","location_mode","created_at","family_plans","is_verified","verification_status","is_onboarded") VALUES
('196','828e673d-606d-4018-9e11-e32a6fc009cc','Алексей','ak@test.ru','Лучший','828e673d-606d-4018-9e11-e32a6fc009cc/1781005053677','2026-06-09 11:17:40.304766+00','man',NULL,'russian, spanish, french',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'f','visible','2026-06-09 11:17:40.304766+00',NULL,'f',NULL,'f'),
('199','e2f3c6e1-f34c-43e1-82c7-517a494e892d','Ольга','test@test.ru','Люблю путешествия','e2f3c6e1-f34c-43e1-82c7-517a494e892d/1781017815873','2026-05-07 09:43:17.614295+00','woman','1998-05-15','english,russian','171','','high_school','no','something_serious','slim','regularly','yes','no','Ищу компанию для поездок','','171','agnostic','t',NULL,'f','while_using','2026-05-07 09:43:17.614295+00',NULL,'f','pending','t'),
('200','3c04af45-d72a-4305-9f75-2bcdcd3032ca','Максим','test@test.com','Спорт и активный отдых',NULL,'2026-05-06 00:22:01.698+00','man','1995-09-20',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'КМС по плаванию, люблю горы',NULL,NULL,NULL,'t',NULL,'f','while_using','2026-05-05 20:11:41.004491+00',NULL,'f','pending','t'),
('201','e82acd8b-b8bf-4f97-99a3-c09ac58f4bc5','Анна','alex@test.ru','Кофе и книги',NULL,'2026-05-07 09:42:59.897384+00','woman','2000-01-10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Работаю в IT, увлекаюсь фотографией',NULL,NULL,NULL,'t',NULL,'f','while_using','2026-05-07 09:42:59.897384+00',NULL,'f','pending','f'),
('202','6450bd60-5c7d-4e6c-afc0-34ef1b2ec273','Денис','super@test.ru','',NULL,'2026-06-03 17:57:59.656006+00','other','2001-06-25','english,russian',NULL,'????????????','high_school',NULL,NULL,NULL,NULL,'yes','yes','dfgdfg',NULL,NULL,NULL,'t',NULL,'f','while_using','2026-06-03 17:57:59.656006+00',NULL,'f','pending','f'),
('203','572db0ac-65d2-4d93-bc80-e331e560cdff','Катя','su@test.ru','Ищу новые знакомства','572db0ac-65d2-4d93-bc80-e331e560cdff/1781017968880','2026-06-04 21:09:36.138306+00','woman','2002-03-12','ukrainian, english',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'yes',NULL,'Студентка, люблю музыку',NULL,NULL,NULL,'t',NULL,'f','while_using','2026-06-04 21:09:36.138306+00',NULL,'f','pending','t');
