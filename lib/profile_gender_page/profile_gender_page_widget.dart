...
import 'profile_gender_page_model.dart';
export 'profile_gender_page_model.dart';

/// Edits the user gender attribute.
class ProfileGenderPageWidget extends StatefulWidget {
  const ProfileGenderPageWidget({super.key});

  static String routeName = 'ProfileGenderPage';
  static String routePath = '/profile-gender';

  @override
  State<ProfileGenderPageWidget> createState() =>
      _ProfileGenderPageWidgetState();
}

class _ProfileGenderPageWidgetState extends State<ProfileGenderPageWidget> {
  late ProfileGenderPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileGenderPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      const options = <String>['woman', 'man', 'other'];
      ...
      final rawText = (profile?['gender'] as String?)?.trim() ?? '';
      _model.gender = normalizeChoice(rawText);
                    ...
                    children: [
                      FloterIconButton(
                        ...
                        onPressed: () async {
                          ...
                          final value =
                              canonicalAttributeValue(_model.gender ?? '');
