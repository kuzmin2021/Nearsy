...
import 'profile_education_page_model.dart';
export 'profile_education_page_model.dart';

/// Edits the user education attribute.
class ProfileEducationPageWidget extends StatefulWidget {
  const ProfileEducationPageWidget({super.key});

  static String routeName = 'ProfileEducationPage';
  static String routePath = '/profile-education';

  @override
  State<ProfileEducationPageWidget> createState() =>
      _ProfileEducationPageWidgetState();
}

class _ProfileEducationPageWidgetState
    extends State<ProfileEducationPageWidget> {
  late ProfileEducationPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileEducationPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      final rawText = (profile?['education'] as String?)?.trim() ?? '';
      _model.education = normalizeChoice(rawText);
                    ...
                    children: [
                      FloterIconButton(
                        ...
                        onPressed: () async {
                          ...
                          final value =
                              canonicalAttributeValue(_model.education ?? '');
                          ...
                          if (context.mounted) {
                            ...
                            context.goNamed(
                              'ProfilePage',
                              queryParameters: {
                                'educationOverride': serializeParam(
                                  navigationValue,
                                  ParamType.String,
                                ),
                              }.withoutNulls,
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  _model.education = 'currently_studying';
                                  safeSetState(() {});
                                },
                                child: Container(
                                  height: 48.0,
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  _model.education = 'trade_qualification';
                                  safeSetState(() {});
                                },
                                child: Container(
                                  height: 48.0,
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  _model.education = 'bachelors_degree';
                                  safeSetState(() {});
                                },
                                child: Container(
                                  height: 48.0,
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  _model.education = 'masters_degree';
                                  safeSetState(() {});
                                },
                                child: Container(
                                  height: 48.0,
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  _model.education = 'doctorate_phd';
                                  safeSetState(() {});
                                },
                                child: Container(
                                  height: 48.0,
