...
import 'floter_util.dart';

Widget wrapWithModel<T extends FloterModel>({
  required T model,
...
T createModel<T extends FloterModel>(
...
abstract class FloterModel<W extends Widget> {
...
class FloterDynamicModels<T extends FloterModel> {
  FloterDynamicModels(this.defaultBuilder);
